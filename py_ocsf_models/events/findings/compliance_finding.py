...
class ComplianceFinding(Finding, BaseModel):
    ...
    Attributes:
        ...
        Disposition ID (disposition_id) [Optional]: The disposition id.
        ...
        Is Alert (is_alert) [Optional]: Determines if the finding is an alert.
        ...
        Time (time_dt) [Optional]: The standardized time when the event occurred or the finding was created, in datetime format.
    ...
    disposition_id: Optional[DispositionID]
