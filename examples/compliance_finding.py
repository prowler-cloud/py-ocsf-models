...
compliance_finding = ComplianceFinding(
    ...
    category_name=CategoryUID.Findings.value,
    class_name=ClassUID.ComplianceFinding.value,
    compliance=Compliance(
        ...
        checks=[
            Check(
                ...
                uid="OSPS-AC-01.01",
                version="2025-02-25",
                severity_uid=SeverityID.Critical.value,
    ...
    disposition_id=DispositionID.NoAction.value,
    evidences=[
        EvidenceArtifacts(
    ...
    type_uid=TypeID.Create,
    type_name="Compliance Finding",
)

# Serialize to JSON
compliance_finding_json = compliance_finding.json()
